...
export const getProfile = asyncHandler(
    async (req, res) => {
        ...
        const adminOrgs = await AdminOrg.find({ primaryAdmin: userId }).populate('organizationId', 'name type clDays foundedAt');
...
export const getProfileByEmail = asyncHandler(
    async (req, res) => {
        ...
        const adminOrgs = await AdminOrg.find({ primaryAdmin: admin._id }).populate('organizationId', 'name type clDays foundedAt');
