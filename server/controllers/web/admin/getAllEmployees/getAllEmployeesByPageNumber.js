...
export const getAllEmployeesByPageNumber = asyncHandler(
  async (req, res) => {
...
export const getManagerEmployees = asyncHandler(
  async (req, res) => {
    ...
    filter.push(
      ...
      { $lookup: { from: "projects", localField: "projectMemberships.projectId", foreignField: "_id", as: "assignedProjects" } },
      {
        $addFields: {
          organizationName: { $ifNull: ["$organization.name", null] },
          departmentName: { $ifNull: ["$team.teamName", null] },
